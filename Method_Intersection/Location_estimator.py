...
class Positioner():
    ...
    def get_XYZ(
        ...
        for afb_pos_1 in points_camera_1:
            ...
            M_afbeelding = np.array([self.calibration_values["image_size"][0] / 2, self.calibration_values["image_size"][1] / 2])
            ...
            C1C2 = self.calibration_values["coord_2"] - self.calibration_values["coord_1"]
            A = np.array(
                [
                    [-C1C2[0], x2[0], y2[0]],
                    [-C1C2[1], x2[1], y2[1]],
            ...
            #   direction:
            connecting_line = np.cross(Line_of_sight_1, self.calibration_values["dir_2"])
            ...
            XYZ_POINTS += [solution_4[0][0] * Line_1 + self.calibration_values["coord_1"]]
