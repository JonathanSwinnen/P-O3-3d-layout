...
def generate_clean_data(data_paths, storing_path="./adjusted_data/clean_ann_scaled.pkl", SCALING_DOWN_FACTOR=4, SUBDIRECOTORY_FOR_IMAGES=False):
    ...
    Original data is stored in  500+ .json files --> all in 1 stored dictionary for easy access.
...
def generate_clean_data_combined(paths):
    """
    Generate clean data in the form of a dictionary for concatenated images.
    Original data is stored in  500+ .json files --> all in 1 stored dictionary for easy access.
    """
    data = dict()
    for path in paths:
        ...
        # the two paths linked to the basic ptath
...
if __name__ == "__main__":
    paths = ('./raw_data/apart_0/', './raw_data/meer_pers_0/', './raw_data/zittend_0/', './raw_data/apart_1/',
             './raw_data/two_0/', './raw_data/meer_pers_1/', './raw_data/zittend_1/', './raw_data/TA_0/', './raw_data/TA_1/',
             './raw_data/two_1/')
