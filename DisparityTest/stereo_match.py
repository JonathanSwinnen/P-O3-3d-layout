...
# source: https://github.com/opencv/opencv/blob/3.4.1/samples/python/stereo_match.py
...
if __name__ == '__main__':
    ...
    imgL = cv.pyrDown( cv.imread('L.jpg') )  # downscale images for faster processing
    imgR = cv.pyrDown( cv.imread('R.jpg') )
